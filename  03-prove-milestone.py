...
def draw_sun(canvas):
    ...
    draw_oval(canvas, 600, 360, 700, 450, width=0, 
              outline="", fill="yellow")

    
def draw_cloud(canvas):
    #x0 left, y0 top, x1 right, y1 bottom
    draw_oval(canvas, 100, 360, 220, 450, width=0, 
              outline="", fill="snow1")
    draw_oval(canvas, 160, 340, 300, 480, width=0, 
              outline="", fill="snow1")
    draw_oval(canvas, 200, 360, 350, 450, width=0, 
              outline="", fill="snow1")
